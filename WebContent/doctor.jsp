...
<body>
	...
	<script>	
			...
			if(jsonData.message!=null)
				{
					...
					var phoneno=details[1];
					row.innerHTML="<td>"+details[0]+"</td><td>"+details[2]+"</td><td>"+details[3]+"</td><td><button class=\"btn btn-danger btn-sm\" onclick=\"sendInstructions1('"+details[0]+"','ambulance','"+details[1]+"')\">Summon Ambulance</button><button type=\"button\" class=\"btn btn-primary btn-sm\" onclick=\"sendInstructions('"+details[0]+"','medication')\">Suggest Medication</button></td>";
				}
		}
		...
		function sendInstructions1(username,message,phoneno)
		{
				websocket.send(username+','+message+','+phoneno);	
		}
	</script>
</body>
</html>