...
<body>
	<div class="container">
		...
		<input class="form-control form-control-sm" type="text" name="phoneno" id="phoneno" style="display:inline-block; width:300px;margin-top:25px;"">
		<br><br>
	...
	<script>
		...
		{
			if(vital1.value<90){
				alert(vital1.value+" pls enter temperature correctly");
			}
			if(vital.value>100){
				alert(vital.value+" pls enter correct oxygen levels");
			}
			if(vital1.value>90 && vital.value<=100){
			websocket.send(phoneno.value+','+vital.value+','+vital1.value);
			phoneno.value="";
			vital.value="";
			vital1.value="";
			}
